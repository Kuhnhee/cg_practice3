...
float speed1 = glm::radians(10.0f);  // 10 degrees/sec for the first rectangle
float speed2 = glm::radians(30.0f);  // 60 degrees/sec for the second rectangle
float speed3 = glm::radians(60.0f);
float speed4 = glm::radians(90.0f);  // 90 degrees/sec for the second rectangle
float speed5 = glm::radians(120.0f);
...
int main()
{
	...
	globalShader = new Shader("4.4.transform.vs", "4.4.transform.fs");
...
GLFWwindow *glAllInit()
{
	...
	window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "Rotation Speed", NULL, NULL);
	if (window == NULL) {
...
void render()
{
	...
	transform = glm::rotate(transform, speed3 * currentTime, glm::vec3(0.0f, 0.0f, 1.0f));
	...
	transform = glm::rotate(transform, speed2 * currentTime, glm::vec3(0.0f, 0.0f, 1.0f));
	transform = glm::translate(transform, glm::vec3(0.7f, 0.0f, 0.0f));
	transform = glm::rotate(transform, speed5 * currentTime, glm::vec3(0.0f, 0.0f, 1.0f));
